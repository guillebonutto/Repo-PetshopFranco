...
var app = new Vue({
	...
	data: {
		...
		nombre: "",
		imagenCompra:
			"https://img.freepik.com/foto-gratis/apreton-manos-negocios-dos-hombres-que-demuestran-su-acuerdo-firmar-acuerdo-o-contrato-sus-empresas-empresas-empresas_1423-100.jpg?size=626&ext=jpg",
	},
	methods: {
		...
		filter(tienda) {
			return tienda.filter((element) => {
				if (
					element.nombre.toLowerCase().includes(this.filterField.toLowerCase()) ||
					this.filterField == ""
				) {
					return element
				}
